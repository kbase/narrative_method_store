...
function NarrativeMethodStore(url, auth, auth_cb) {
    ...
    this.enable_repo = function (params, _callback, _errorCallback) {
        return json_call_ajax("NarrativeMethodStore.enable_repo",
                [params], 0, _callback, _errorCallback);
    };

    this.enable_repo_async = function (params, _callback, _error_callback) {
            deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.enable_repo", [params], 0, _callback, _error_callback);
    };

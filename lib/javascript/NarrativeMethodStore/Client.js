...
function NarrativeMethodStore(url, auth, auth_cb) {
    ...
    return json_call_ajax("NarrativeMethodStore.is_repo_registered",
        [params], 1, _callback, _errorCallback);
};

    this.is_repo_registered_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.is_repo_registered", [params], 1, _callback, _error_callback);
    };
    ...
    this.register_repo_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.register_repo", [params], 1, _callback, _error_callback);
    };

    this.get_repo_last_version = function (params, _callback, _errorCallback) {
    return json_call_ajax("NarrativeMethodStore.get_repo_last_version",
        [params], 1, _callback, _errorCallback);
};

    this.get_repo_last_version_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.get_repo_last_version", [params], 1, _callback, _error_callback);
    };

    this.list_repo_module_names = function (params, _callback, _errorCallback) {
    return json_call_ajax("NarrativeMethodStore.list_repo_module_names",
        [params], 1, _callback, _errorCallback);
};

    this.list_repo_module_names_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.list_repo_module_names", [params], 1, _callback, _error_callback);
    };

    this.get_repo_details = function (params, _callback, _errorCallback) {
    return json_call_ajax("NarrativeMethodStore.get_repo_details",
        [params], 1, _callback, _errorCallback);
};

    this.get_repo_details_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.get_repo_details", [params], 1, _callback, _error_callback);
    };

    this.list_repo_versions = function (params, _callback, _errorCallback) {
    return json_call_ajax("NarrativeMethodStore.list_repo_versions",
        [params], 1, _callback, _errorCallback);
};

    this.list_repo_versions_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.list_repo_versions", [params], 1, _callback, _error_callback);
    };
    ...
    return json_call_ajax("NarrativeMethodStore.set_repo_state",
        [params], 0, _callback, _errorCallback);
};

    this.set_repo_state_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.set_repo_state", [params], 0, _callback, _error_callback);
    };

    this.get_repo_state = function (params, _callback, _errorCallback) {
    return json_call_ajax("NarrativeMethodStore.get_repo_state",
        [params], 1, _callback, _errorCallback);
};

    this.get_repo_state_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.get_repo_state", [params], 1, _callback, _error_callback);
    };
